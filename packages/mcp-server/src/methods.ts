...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.messages.listAttachments',
    fullyQualifiedName: 'messages.listAttachments',
    httpMethod: 'get',
    httpPath: '/v1/messages/{messageId}/attachments',
  },
  {
  ...
  {
    clientCallName: 'client.templates.sync',
    fullyQualifiedName: 'templates.sync',
    httpMethod: 'post',
    httpPath: '/v1/templates/sync',
  },
  {
  ...
  {
    clientCallName: 'client.senders.agent.tools.listTestRuns',
    fullyQualifiedName: 'senders.agent.tools.listTestRuns',
    httpMethod: 'get',
    httpPath: '/v1/senders/{senderId}/agent/tools/{toolId}/test-runs',
  },
  {
  ...
  {
    clientCallName: 'client.senders.agent.tools.webhook.rotateSecret',
    fullyQualifiedName: 'senders.agent.tools.webhook.rotateSecret',
    httpMethod: 'post',
    httpPath: '/v1/senders/{senderId}/agent/tools/{toolId}/webhook/secret',
  },
  {
  ...
  {
    clientCallName: 'client.senders.agent.knowledgeBases.documents.retrieveDocument',
    fullyQualifiedName: 'senders.agent.knowledgeBases.documents.retrieveDocument',
    httpMethod: 'get',
    httpPath: '/v1/senders/{senderId}/agent/knowledge-bases/{kbId}/documents/{docId}',
  },
  {
    clientCallName: 'client.senders.agent.knowledgeBases.documents.updateDocument',
    fullyQualifiedName: 'senders.agent.knowledgeBases.documents.updateDocument',
    httpMethod: 'patch',
    httpPath: '/v1/senders/{senderId}/agent/knowledge-bases/{kbId}/documents/{docId}',
  },
  {
  ...
  {
    clientCallName: 'client.senders.telegram.connect',
    fullyQualifiedName: 'senders.telegram.connect',
    httpMethod: 'post',
    httpPath: '/v1/senders/{senderId}/telegram',
  },
  {
    clientCallName: 'client.senders.telegram.disconnect',
    fullyQualifiedName: 'senders.telegram.disconnect',
    httpMethod: 'delete',
    httpPath: '/v1/senders/{senderId}/telegram',
  },
  {
  ...
  {
    clientCallName: 'client.introspect.validateEmail',
    fullyQualifiedName: 'introspect.validateEmail',
    httpMethod: 'post',
    httpPath: '/v1/introspect/email',
  },
  {
  ...
  {
    clientCallName: 'client.urls.escalate',
    fullyQualifiedName: 'urls.escalate',
    httpMethod: 'post',
    httpPath: '/v1/urls/{urlId}/escalate',
  },
  {
  ...
  {
    clientCallName: 'client.functions.listDeployments',
    fullyQualifiedName: 'functions.listDeployments',
    httpMethod: 'get',
    httpPath: '/v1/functions/{functionId}/deployments',
  },
  {
    clientCallName: 'client.functions.listEventTypes',
    fullyQualifiedName: 'functions.listEventTypes',
    httpMethod: 'get',
    httpPath: '/v1/functions/event-types',
  },
  {
    clientCallName: 'client.functions.rollbackDeployment',
    fullyQualifiedName: 'functions.rollbackDeployment',
    httpMethod: 'post',
    httpPath: '/v1/functions/{functionId}/rollback',
  },
  {
  ...
  {
    clientCallName: 'client.functions.triggers.create',
    fullyQualifiedName: 'functions.triggers.create',
    httpMethod: 'post',
    httpPath: '/v1/functions/{functionId}/triggers',
  },
  {
    clientCallName: 'client.functions.triggers.update',
    fullyQualifiedName: 'functions.triggers.update',
    httpMethod: 'patch',
    httpPath: '/v1/functions/triggers/{triggerId}',
  },
  {
    clientCallName: 'client.functions.triggers.list',
    fullyQualifiedName: 'functions.triggers.list',
    httpMethod: 'get',
    httpPath: '/v1/functions/{functionId}/triggers',
  },
  {
    clientCallName: 'client.functions.triggers.delete',
    fullyQualifiedName: 'functions.triggers.delete',
    httpMethod: 'delete',
    httpPath: '/v1/functions/triggers/{triggerId}',
  },
  {
    clientCallName: 'client.functions.gitLink.retrieve',
    fullyQualifiedName: 'functions.gitLink.retrieve',
    httpMethod: 'get',
    httpPath: '/v1/functions/{functionId}/git-link',
  },
  {
    clientCallName: 'client.functions.gitLink.update',
    fullyQualifiedName: 'functions.gitLink.update',
    httpMethod: 'patch',
    httpPath: '/v1/functions/{functionId}/git-link',
  },
  {
    clientCallName: 'client.functions.gitLink.deployNow',
    fullyQualifiedName: 'functions.gitLink.deployNow',
    httpMethod: 'post',
    httpPath: '/v1/functions/{functionId}/git-link/deploy',
  },
  {
    clientCallName: 'client.functions.gitLink.link',
    fullyQualifiedName: 'functions.gitLink.link',
    httpMethod: 'post',
    httpPath: '/v1/functions/{functionId}/git-link',
  },
  {
    clientCallName: 'client.functions.gitLink.unlink',
    fullyQualifiedName: 'functions.gitLink.unlink',
    httpMethod: 'delete',
    httpPath: '/v1/functions/{functionId}/git-link',
  },
  {
    ...
    httpMethod: 'get',
    httpPath: '/v1/conversations/{conversationId}',
  },
  {
    clientCallName: 'client.conversations.list',
    fullyQualifiedName: 'conversations.list',
    httpMethod: 'get',
    httpPath: '/v1/conversations',
  },
  {
    clientCallName: 'client.conversations.listMessages',
    fullyQualifiedName: 'conversations.listMessages',
    httpMethod: 'get',
    httpPath: '/v1/conversations/{conversationId}/messages',
  },
  {
    clientCallName: 'client.conversations.markAsRead',
    fullyQualifiedName: 'conversations.markAsRead',
    httpMethod: 'post',
    httpPath: '/v1/conversations/{conversationId}/read',
  },
  {
  ...
  {
    clientCallName: 'client.calls.hangup',
    fullyQualifiedName: 'calls.hangup',
    httpMethod: 'post',
    httpPath: '/v1/calls/{callId}/hangup',
  },
  {
    clientCallName: 'client.agentTemplates.retrieve',
    fullyQualifiedName: 'agentTemplates.retrieve',
    httpMethod: 'get',
    httpPath: '/v1/agent-templates/{templateId}',
  },
  {
    clientCallName: 'client.agentTemplates.list',
    fullyQualifiedName: 'agentTemplates.list',
    httpMethod: 'get',
    httpPath: '/v1/agent-templates',
  },
  {
    clientCallName: 'client.emailDomains.create',
    fullyQualifiedName: 'emailDomains.create',
    httpMethod: 'post',
    httpPath: '/v1/email-domains',
  },
  {
    clientCallName: 'client.emailDomains.retrieve',
    fullyQualifiedName: 'emailDomains.retrieve',
    httpMethod: 'get',
    httpPath: '/v1/email-domains/{domainId}',
  },
  {
    clientCallName: 'client.emailDomains.list',
    fullyQualifiedName: 'emailDomains.list',
    httpMethod: 'get',
    httpPath: '/v1/email-domains',
  },
  {
    clientCallName: 'client.emailDomains.delete',
    fullyQualifiedName: 'emailDomains.delete',
    httpMethod: 'delete',
    httpPath: '/v1/email-domains/{domainId}',
  },
  {
    clientCallName: 'client.emailDomains.verify',
    fullyQualifiedName: 'emailDomains.verify',
    httpMethod: 'post',
    httpPath: '/v1/email-domains/{domainId}/verify',
  },
  {
  ...
  {
    clientCallName: 'client.agents.listVoices',
    fullyQualifiedName: 'agents.listVoices',
    httpMethod: 'get',
    httpPath: '/v1/agents/voices',
  },
  {
    clientCallName: 'client.agents.test',
    fullyQualifiedName: 'agents.test',
    httpMethod: 'post',
    httpPath: '/v1/agents/{agentId}/test',
  },
  {
    clientCallName: 'client.agents.senders.connect',
    fullyQualifiedName: 'agents.senders.connect',
    httpMethod: 'post',
    httpPath: '/v1/agents/{agentId}/senders',
  },
  {
    clientCallName: 'client.agents.senders.disconnect',
    fullyQualifiedName: 'agents.senders.disconnect',
    httpMethod: 'delete',
    httpPath: '/v1/agents/{agentId}/senders/{senderId}',
  },
];
