...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; channel: string; createdAt: string; messageType: string; status: string; to: string; content?: { buttons?: object[]; contacts?: object[]; ctaDisplayText?: string; ctaHeaderMediaUrl?: string; ctaHeaderText?: string; ctaHeaderType?: 'text' | 'image' | 'video' | 'document'; ctaUrl?: string; emoji?: string; filename?: string; footerText?: string; latitude?: number; listButton?: string; locationAddress?: string; locationName?: string; longitude?: number; mediaId?: string; mediaUrl?: string; mimeType?: string; reactToMessageId?: string; replyToFrom?: string; replyToMessageId?: string; replyToMessageType?: string; replyToProviderMessageId?: string; replyToText?: string; sections?: object[]; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; }; conversationId?: string; cost?: number; costProvider?: number; costTotal?: number; errorCode?: string; errorMessage?: string; from?: string; metadata?: object; providerMessageId?: string; senderId?: string; text?: string; updatedAt?: string; }",
    markdown:
      "## list\n\n`client.messages.list(channel?: 'sms' | 'sms_oneway' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice', cursor?: string, limit?: number, status?: 'queued' | 'sending' | 'sent' | 'delivered' | 'failed' | 'received', to?: string): { id: string; channel: channel; createdAt: string; messageType: message_type; status: message_status; to: string; content?: message_content; conversationId?: string; cost?: number; costProvider?: number; costTotal?: number; errorCode?: string; errorMessage?: string; from?: string; metadata?: object; providerMessageId?: string; senderId?: string; text?: string; updatedAt?: string; }`\n\n**get** `/v1/messages`\n\nList messages previously sent by this project.\n\n### Parameters\n\n- `channel?: 'sms' | 'sms_oneway' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'`\n  Filter by delivery channel.\n\n- `cursor?: string`\n\n- `limit?: number`\n\n- `status?: 'queued' | 'sending' | 'sent' | 'delivered' | 'failed' | 'received'`\n  Filter by status. Not all stored statuses are filterable.\n\n- `to?: string`\n\n### Returns\n\n- `{ id: string; channel: string; createdAt: string; messageType: string; status: string; to: string; content?: { buttons?: object[]; contacts?: object[]; ctaDisplayText?: string; ctaHeaderMediaUrl?: string; ctaHeaderText?: string; ctaHeaderType?: 'text' | 'image' | 'video' | 'document'; ctaUrl?: string; emoji?: string; filename?: string; footerText?: string; latitude?: number; listButton?: string; locationAddress?: string; locationName?: string; longitude?: number; mediaId?: string; mediaUrl?: string; mimeType?: string; reactToMessageId?: string; replyToFrom?: string; replyToMessageId?: string; replyToMessageType?: string; replyToProviderMessageId?: string; replyToText?: string; sections?: object[]; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; }; conversationId?: string; cost?: number; costProvider?: number; costTotal?: number; errorCode?: string; errorMessage?: string; from?: string; metadata?: object; providerMessageId?: string; senderId?: string; text?: string; updatedAt?: string; }`\n\n  - `id: string`\n  - `channel: string`\n  - `createdAt: string`\n  - `messageType: string`\n  - `status: string`\n  - `to: string`\n  - `content?: { buttons?: { id: string; title: string; }[]; contacts?: { name?: string; phones?: string[]; }[]; ctaDisplayText?: string; ctaHeaderMediaUrl?: string; ctaHeaderText?: string; ctaHeaderType?: 'text' | 'image' | 'video' | 'document'; ctaUrl?: string; emoji?: string; filename?: string; footerText?: string; latitude?: number; listButton?: string; locationAddress?: string; locationName?: string; longitude?: number; mediaId?: string; mediaUrl?: string; mimeType?: string; reactToMessageId?: string; replyToFrom?: string; replyToMessageId?: string; replyToMessageType?: string; replyToProviderMessageId?: string; replyToText?: string; sections?: { rows: { id: string; title: string; description?: string; }[]; title: string; }[]; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; }`\n  - `conversationId?: string`\n  - `cost?: number`\n  - `costProvider?: number`\n  - `costTotal?: number`\n  - `errorCode?: string`\n  - `errorMessage?: string`\n  - `from?: string`\n  - `metadata?: object`\n  - `providerMessageId?: string`\n  - `senderId?: string`\n  - `text?: string`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\n// Automatically fetches more pages as needed.\nfor await (const message of client.messages.list()) {\n  console.log(message);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      ...
      'name: string;',
      'addSecurityRecommendation?: boolean;',
      "buttons?: { type: 'quick_reply' | 'url' | 'phone' | 'otp' | 'request_contact_info'; example?: string; otpType?: 'COPY_CODE' | 'ONE_TAP'; packageName?: string; phoneNumber?: string; signatureHash?: string; text?: string; url?: string; }[];",
      'codeExpirationMinutes?: number;',
      'footer?: string;',
      'headerContent?: string;',
  ...
  },
  {
    ...
    perLanguage: {
      ...
      ruby: {
        method: 'senders.create',
        example:
          'require "zavudev"\n\nzavudev = Zavudev::Client.new(api_key: "My API Key")\n\nsender = zavudev.senders.create(name: "name")\n\nputs(sender)',
      },
      cli: {
        method: 'senders create',
        example: "zavudev senders create \\\n  --api-key 'My API Key' \\\n  --name name",
      },
      php: {
        method: 'senders->create',
        example:
  ...
  },
  {
    ...
    params: ['senderId: string;'],
    response:
      '{ agent: { id: string; createdAt: string; enabled: boolean; model: string; name: string; provider: agent_provider; senderId: string; systemPrompt: string; updatedAt: string; contextWindowMessages?: number; includeContactMetadata?: boolean; maxTokens?: number; senderIds?: string[]; stats?: object; temperature?: number; triggerOnChannels?: string[]; triggerOnMessageTypes?: string[]; voice?: object; }; }',
    markdown:
      "## retrieve\n\n`client.senders.agent.retrieve(senderId: string): { agent: agent; }`\n\n**get** `/v1/senders/{senderId}/agent`\n\nGet the AI agent configuration for a sender.\n\n### Parameters\n\n- `senderId: string`\n\n### Returns\n\n- `{ agent: { id: string; createdAt: string; enabled: boolean; model: string; name: string; provider: agent_provider; senderId: string; systemPrompt: string; updatedAt: string; contextWindowMessages?: number; includeContactMetadata?: boolean; maxTokens?: number; senderIds?: string[]; stats?: object; temperature?: number; triggerOnChannels?: string[]; triggerOnMessageTypes?: string[]; voice?: object; }; }`\n\n  - `agent: { id: string; createdAt: string; enabled: boolean; model: string; name: string; provider: 'openai' | 'anthropic' | 'google' | 'mistral' | 'zavu'; senderId: string; systemPrompt: string; updatedAt: string; contextWindowMessages?: number; includeContactMetadata?: boolean; maxTokens?: number; senderIds?: string[]; stats?: { totalCost?: number; totalInvocations?: number; totalTokensUsed?: number; }; temperature?: number; triggerOnChannels?: string[]; triggerOnMessageTypes?: string[]; voice?: { enabled: boolean; greeting?: string; greetings?: object; interruptible?: boolean; language?: string; maxCallDurationMinutes?: number; maxIdleSeconds?: number; model?: string; recordCalls?: boolean; sttModel?: string; sttProvider?: string; transferPhoneNumber?: string; ttsProvider?: string; ttsVoiceId?: string; voicemailAction?: 'hangup' | 'leave_message'; voicemailMessage?: string; voiceSpeed?: number; }; }`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst agentResponse = await client.senders.agent.retrieve('senderId');\n\nconsole.log(agentResponse);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ agent: { id: string; createdAt: string; enabled: boolean; model: string; name: string; provider: agent_provider; senderId: string; systemPrompt: string; updatedAt: string; contextWindowMessages?: number; includeContactMetadata?: boolean; maxTokens?: number; senderIds?: string[]; stats?: object; temperature?: number; triggerOnChannels?: string[]; triggerOnMessageTypes?: string[]; voice?: object; }; }',
    markdown:
      "## update\n\n`client.senders.agent.update(senderId: string, apiKey?: string, contextWindowMessages?: number, enabled?: boolean, includeContactMetadata?: boolean, maxTokens?: number, model?: string, name?: string, provider?: 'openai' | 'anthropic' | 'google' | 'mistral' | 'zavu', systemPrompt?: string, temperature?: number, triggerOnChannels?: string[], triggerOnMessageTypes?: string[], voice?: { enabled: boolean; greeting?: string; greetings?: object; interruptible?: boolean; language?: string; maxCallDurationMinutes?: number; maxIdleSeconds?: number; model?: string; recordCalls?: boolean; sttModel?: string; sttProvider?: string; transferPhoneNumber?: string; ttsProvider?: string; ttsVoiceId?: string; voicemailAction?: 'hangup' | 'leave_message'; voicemailMessage?: string; voiceSpeed?: number; }): { agent: agent; }`\n\n**patch** `/v1/senders/{senderId}/agent`\n\nUpdate an AI agent's configuration.\n\n### Parameters\n\n- `senderId: string`\n\n- `apiKey?: string`\n\n- `contextWindowMessages?: number`\n\n- `enabled?: boolean`\n\n- `includeContactMetadata?: boolean`\n\n- `maxTokens?: number`\n\n- `model?: string`\n\n- `name?: string`\n\n- `provider?: 'openai' | 'anthropic' | 'google' | 'mistral' | 'zavu'`\n  LLM provider for the AI agent.\n\n- `systemPrompt?: string`\n\n- `temperature?: number`\n\n- `triggerOnChannels?: string[]`\n\n- `triggerOnMessageTypes?: string[]`\n\n- `voice?: { enabled: boolean; greeting?: string; greetings?: object; interruptible?: boolean; language?: string; maxCallDurationMinutes?: number; maxIdleSeconds?: number; model?: string; recordCalls?: boolean; sttModel?: string; sttProvider?: string; transferPhoneNumber?: string; ttsProvider?: string; ttsVoiceId?: string; voicemailAction?: 'hangup' | 'leave_message'; voicemailMessage?: string; voiceSpeed?: number; }`\n  Voice Agent configuration. Patch this object to enable voice, change the greeting, or adjust call limits. Requires the Voice Agents feature to be enabled for your team.\n  - `enabled: boolean`\n    Whether the agent handles voice calls. When false, the sender's number is not answered by the voice agent and outbound calls are rejected.\n  - `greeting?: string`\n    Opening line the agent speaks when the call connects. If omitted, the agent waits for the caller to speak first.\n  - `greetings?: object`\n    Greeting per language, keyed by language code. Used when the caller's language differs from the one `greeting` is written in.\n  - `interruptible?: boolean`\n    Whether the caller can interrupt the agent while it is speaking (barge-in). When true, the agent stops talking as soon as the caller starts.\n  - `language?: string`\n    BCP-47 language code used for both speech recognition and speech synthesis (e.g. `en`, `es`, `pt-BR`). Auto-detected from the recipient when omitted.\n  - `maxCallDurationMinutes?: number`\n    Hard limit on call length in minutes. The call ends automatically when reached.\n  - `maxIdleSeconds?: number`\n    How long the agent waits during silence before ending the call.\n  - `model?: string`\n    Model that runs the conversation, co-located in the voice network for lowest latency. Independent of the model used for text messaging. Derived from the agent's text model when omitted.\n  - `recordCalls?: boolean`\n    Whether the call audio is recorded.\n  - `sttModel?: string`\n    Speech-recognition model. Uses the default when omitted.\n  - `sttProvider?: string`\n    Speech-recognition provider. Uses the default when omitted.\n  - `transferPhoneNumber?: string`\n    E.164 phone number the agent can transfer the call to. When set, the agent is given a transfer tool it can use to hand the call to a human.\n  - `ttsProvider?: string`\n    Speech-synthesis provider. Uses the default when omitted.\n  - `ttsVoiceId?: string`\n    Identifier of the synthesized voice that speaks. Choose from the voices available in the dashboard. Uses a neutral default when omitted.\n  - `voicemailAction?: 'hangup' | 'leave_message'`\n    What the agent does when an answering machine or voicemail is detected on an outbound call.\n  - `voicemailMessage?: string`\n    Message spoken when `voicemailAction` is `leave_message`. Falls back to `greeting` when omitted.\n  - `voiceSpeed?: number`\n    Speech rate. 1.0 is natural. Only honoured by voices that support rate control; ignored by the others.\n\n### Returns\n\n- `{ agent: { id: string; createdAt: string; enabled: boolean; model: string; name: string; provider: agent_provider; senderId: string; systemPrompt: string; updatedAt: string; contextWindowMessages?: number; includeContactMetadata?: boolean; maxTokens?: number; senderIds?: string[]; stats?: object; temperature?: number; triggerOnChannels?: string[]; triggerOnMessageTypes?: string[]; voice?: object; }; }`\n\n  - `agent: { id: string; createdAt: string; enabled: boolean; model: string; name: string; provider: 'openai' | 'anthropic' | 'google' | 'mistral' | 'zavu'; senderId: string; systemPrompt: string; updatedAt: string; contextWindowMessages?: number; includeContactMetadata?: boolean; maxTokens?: number; senderIds?: string[]; stats?: { totalCost?: number; totalInvocations?: number; totalTokensUsed?: number; }; temperature?: number; triggerOnChannels?: string[]; triggerOnMessageTypes?: string[]; voice?: { enabled: boolean; greeting?: string; greetings?: object; interruptible?: boolean; language?: string; maxCallDurationMinutes?: number; maxIdleSeconds?: number; model?: string; recordCalls?: boolean; sttModel?: string; sttProvider?: string; transferPhoneNumber?: string; ttsProvider?: string; ttsVoiceId?: string; voicemailAction?: 'hangup' | 'leave_message'; voicemailMessage?: string; voiceSpeed?: number; }; }`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst agentResponse = await client.senders.agent.update('senderId');\n\nconsole.log(agentResponse);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; agentId: string; cost: number; createdAt: string; inputTokens: number; latencyMs: number; outputTokens: number; status: 'success' | 'error' | 'filtered' | 'rate_limited' | 'balance_insufficient'; errorMessage?: string; inboundMessageId?: string; knowledgeChunksUsed?: number; responseMessageId?: string; responseText?: string; toolCalls?: number; }",
    markdown:
      "## list\n\n`client.senders.agent.executions.list(senderId: string, cursor?: string, limit?: number, status?: 'success' | 'error' | 'filtered' | 'rate_limited' | 'balance_insufficient'): { id: string; agentId: string; cost: number; createdAt: string; inputTokens: number; latencyMs: number; outputTokens: number; status: agent_execution_status; errorMessage?: string; inboundMessageId?: string; knowledgeChunksUsed?: number; responseMessageId?: string; responseText?: string; toolCalls?: number; }`\n\n**get** `/v1/senders/{senderId}/agent/executions`\n\nList recent agent executions with pagination.\n\nAn execution is one inbound message answered by the agent, so this covers the messaging channels only. Voice calls are never listed here regardless of how many the agent handled. Use `GET /v1/calls` (and `GET /v1/calls/{callId}` for the transcript) for voice.\n\n### Parameters\n\n- `senderId: string`\n\n- `cursor?: string`\n\n- `limit?: number`\n\n- `status?: 'success' | 'error' | 'filtered' | 'rate_limited' | 'balance_insufficient'`\n  Status of an agent execution.\n\n### Returns\n\n- `{ id: string; agentId: string; cost: number; createdAt: string; inputTokens: number; latencyMs: number; outputTokens: number; status: 'success' | 'error' | 'filtered' | 'rate_limited' | 'balance_insufficient'; errorMessage?: string; inboundMessageId?: string; knowledgeChunksUsed?: number; responseMessageId?: string; responseText?: string; toolCalls?: number; }`\n\n  - `id: string`\n  - `agentId: string`\n  - `cost: number`\n  - `createdAt: string`\n  - `inputTokens: number`\n  - `latencyMs: number`\n  - `outputTokens: number`\n  - `status: 'success' | 'error' | 'filtered' | 'rate_limited' | 'balance_insufficient'`\n  - `errorMessage?: string`\n  - `inboundMessageId?: string`\n  - `knowledgeChunksUsed?: number`\n  - `responseMessageId?: string`\n  - `responseText?: string`\n  - `toolCalls?: number`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\n// Automatically fetches more pages as needed.\nfor await (const agentExecution of client.senders.agent.executions.list('senderId')) {\n  console.log(agentExecution);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ execution: { id: string; agentId: string; cost: number; createdAt: string; inputTokens: number; latencyMs: number; outputTokens: number; status: agent_execution_status; errorMessage?: string; inboundMessageId?: string; knowledgeChunksUsed?: number; responseMessageId?: string; responseText?: string; toolCalls?: number; }; }',
    markdown:
  ...
  },
  {
    ...
    response:
      '{ run: { id: string; createdAt: string; durationMs: number; success: boolean; toolId: string; error?: string; params?: object; response?: string; statusCode?: number; }; }',
    markdown:
      "## test\n\n`client.senders.agent.tools.test(senderId: string, toolId: string, testParams: object): { run: object; }`\n\n**post** `/v1/senders/{senderId}/agent/tools/{toolId}/test`\n\nRun a tool with the parameters you supply and return what it answered.\n\nThe call is synchronous: the response carries the tool's status, body, and duration, so a green result is evidence the tool ran rather than evidence it was accepted. Each run is also recorded and readable afterwards via `GET /v1/senders/{senderId}/agent/tools/{toolId}/test-runs`.\n\nA tool that answers with an error is reported as a run with `success: false` — the endpoint itself still returns 200. This fires the tool's real webhook, so a test has whatever side effects the tool has.\n\n### Parameters\n\n- `senderId: string`\n\n- `toolId: string`\n\n- `testParams: object`\n  Parameters to pass to the tool for testing.\n\n### Returns\n\n- `{ run: { id: string; createdAt: string; durationMs: number; success: boolean; toolId: string; error?: string; params?: object; response?: string; statusCode?: number; }; }`\n\n  - `run: { id: string; createdAt: string; durationMs: number; success: boolean; toolId: string; error?: string; params?: object; response?: string; statusCode?: number; }`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst response = await client.senders.agent.tools.test('toolId', {\n  senderId: 'senderId',\n  testParams: { order_id: 'bar' },\n});\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }",
    markdown:
      "## list\n\n`client.contacts.list(cursor?: string, limit?: number, phoneNumber?: string): { id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: contact_channel[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n**get** `/v1/contacts`\n\nList contacts with their communication channels.\n\n### Parameters\n\n- `cursor?: string`\n\n- `limit?: number`\n\n- `phoneNumber?: string`\n\n### Returns\n\n- `{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n  - `id: string`\n  - `availableChannels: string[]`\n  - `createdAt: string`\n  - `metadata: object`\n  - `verified: boolean`\n  - `channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: { avgDeliveryTimeMs?: number; failureCount?: number; lastSuccessAt?: string; successCount?: number; totalAttempts?: number; }; updatedAt?: string; }[]`\n  - `countryCode?: string`\n  - `defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'`\n  - `displayName?: string`\n  - `phoneNumber?: string`\n  - `primaryEmail?: string`\n  - `primaryPhone?: string`\n  - `profileName?: string`\n  - `suggestedMergeWith?: string`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\n// Automatically fetches more pages as needed.\nfor await (const contact of client.contacts.list()) {\n  console.log(contact);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }",
    markdown:
      "## update\n\n`client.contacts.update(contactId: string, defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice', metadata?: object): { id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: contact_channel[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n**patch** `/v1/contacts/{contactId}`\n\nUpdate contact\n\n### Parameters\n\n- `contactId: string`\n\n- `defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'`\n  Preferred channel for this contact. Set to null to clear.\n\n- `metadata?: object`\n\n### Returns\n\n- `{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n  - `id: string`\n  - `availableChannels: string[]`\n  - `createdAt: string`\n  - `metadata: object`\n  - `verified: boolean`\n  - `channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: { avgDeliveryTimeMs?: number; failureCount?: number; lastSuccessAt?: string; successCount?: number; totalAttempts?: number; }; updatedAt?: string; }[]`\n  - `countryCode?: string`\n  - `defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'`\n  - `displayName?: string`\n  - `phoneNumber?: string`\n  - `primaryEmail?: string`\n  - `primaryPhone?: string`\n  - `profileName?: string`\n  - `suggestedMergeWith?: string`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst contact = await client.contacts.update('contactId');\n\nconsole.log(contact);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      "channels: { channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; identifier: string; countryCode?: string; isPrimary?: boolean; label?: string; }[];",
      'displayName?: string;',
      'metadata?: object;',
    ],
    response:
      "{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }",
    markdown:
      "## create\n\n`client.contacts.create(channels: { channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; identifier: string; countryCode?: string; isPrimary?: boolean; label?: string; }[], displayName?: string, metadata?: object): { id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: contact_channel[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n**post** `/v1/contacts`\n\nCreate a new contact with one or more communication channels.\n\n### Parameters\n\n- `channels: { channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; identifier: string; countryCode?: string; isPrimary?: boolean; label?: string; }[]`\n  Communication channels for the contact.\n\n- `displayName?: string`\n  Display name for the contact.\n\n- `metadata?: object`\n  Arbitrary metadata to associate with the contact.\n\n### Returns\n\n- `{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n  - `id: string`\n  - `availableChannels: string[]`\n  - `createdAt: string`\n  - `metadata: object`\n  - `verified: boolean`\n  - `channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: { avgDeliveryTimeMs?: number; failureCount?: number; lastSuccessAt?: string; successCount?: number; totalAttempts?: number; }; updatedAt?: string; }[]`\n  - `countryCode?: string`\n  - `defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'`\n  - `displayName?: string`\n  - `phoneNumber?: string`\n  - `primaryEmail?: string`\n  - `primaryPhone?: string`\n  - `profileName?: string`\n  - `suggestedMergeWith?: string`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst contact = await client.contacts.create({ channels: [{ channel: 'sms', identifier: '+14155551234' }] });\n\nconsole.log(contact);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ channel: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }; }",
    markdown:
      "## add\n\n`client.contacts.channels.add(contactId: string, channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice', identifier: string, countryCode?: string, isPrimary?: boolean, label?: string): { channel: contact_channel; }`\n\n**post** `/v1/contacts/{contactId}/channels`\n\nAdd a new communication channel to an existing contact.\n\n### Parameters\n\n- `contactId: string`\n\n- `channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'`\n  Channel type.\n\n- `identifier: string`\n  Channel identifier (phone number in E.164 format or email address).\n\n- `countryCode?: string`\n  ISO country code for phone numbers.\n\n- `isPrimary?: boolean`\n  Whether this should be the primary channel for its type.\n\n- `label?: string`\n  Optional label for the channel.\n\n### Returns\n\n- `{ channel: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }; }`\n\n  - `channel: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'instagram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: { avgDeliveryTimeMs?: number; failureCount?: number; lastSuccessAt?: string; successCount?: number; totalAttempts?: number; }; updatedAt?: string; }`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst response = await client.contacts.channels.add('contactId', { channel: 'email', identifier: 'john.work@company.com' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      ...
      'name: string;',
      'content?: { filename?: string; mediaId?: string; mediaUrl?: string; mimeType?: string; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; };',
  ...
  },
  {
    ...
    response:
      "{ id: string; token: string; createdAt: string; expiresAt: string; status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled' | 'failed'; updatedAt: string; url: string; clientEmail?: string; clientName?: string; clientPhone?: string; completedAt?: string; connectedAccount?: { id: string; channel: 'whatsapp' | 'messenger'; name?: string; }; connectionType?: 'whatsapp_waba' | 'messenger'; failedAt?: string; failureReason?: string; phoneNumberId?: string; senderId?: string; startedAt?: string; viewedAt?: string; }",
    markdown:
      "## list\n\n`client.invitations.list(cursor?: string, limit?: number, status?: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled' | 'failed'): { id: string; token: string; createdAt: string; expiresAt: string; status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled' | 'failed'; updatedAt: string; url: string; clientEmail?: string; clientName?: string; clientPhone?: string; completedAt?: string; connectedAccount?: object; connectionType?: 'whatsapp_waba' | 'messenger'; failedAt?: string; failureReason?: string; phoneNumberId?: string; senderId?: string; startedAt?: string; viewedAt?: string; }`\n\n**get** `/v1/invitations`\n\nList partner invitations for this project.\n\n### Parameters\n\n- `cursor?: string`\n\n- `limit?: number`\n\n- `status?: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled' | 'failed'`\n  Current status of the partner invitation.\n\n`failed` means the client started the connection and it did not finish (they cancelled Meta's dialog, denied a permission, or abandoned the tab). A failed invitation is still usable: the same link can be retried, and it moves back to `in_progress` when the client tries again.\n\n### Returns\n\n- `{ id: string; token: string; createdAt: string; expiresAt: string; status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled' | 'failed'; updatedAt: string; url: string; clientEmail?: string; clientName?: string; clientPhone?: string; completedAt?: string; connectedAccount?: { id: string; channel: 'whatsapp' | 'messenger'; name?: string; }; connectionType?: 'whatsapp_waba' | 'messenger'; failedAt?: string; failureReason?: string; phoneNumberId?: string; senderId?: string; startedAt?: string; viewedAt?: string; }`\n\n  - `id: string`\n  - `token: string`\n  - `createdAt: string`\n  - `expiresAt: string`\n  - `status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled' | 'failed'`\n  - `updatedAt: string`\n  - `url: string`\n  - `clientEmail?: string`\n  - `clientName?: string`\n  - `clientPhone?: string`\n  - `completedAt?: string`\n  - `connectedAccount?: { id: string; channel: 'whatsapp' | 'messenger'; name?: string; }`\n  - `connectionType?: 'whatsapp_waba' | 'messenger'`\n  - `failedAt?: string`\n  - `failureReason?: string`\n  - `phoneNumberId?: string`\n  - `senderId?: string`\n  - `startedAt?: string`\n  - `viewedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\n// Automatically fetches more pages as needed.\nfor await (const invitation of client.invitations.list()) {\n  console.log(invitation);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['url: string;'],
    response:
      "{ url: { id: string; createdAt: string; domain: string; status: 'pending' | 'approved' | 'rejected' | 'escalated' | 'malicious'; url: string; approvalType?: 'manual' | 'auto_web_risk'; updatedAt?: string; }; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ id: string; createdAt: string; domain: string; status: 'pending' | 'approved' | 'rejected' | 'escalated' | 'malicious'; url: string; approvalType?: 'manual' | 'auto_web_risk'; updatedAt?: string; }",
    markdown:
      "## list_verified\n\n`client.urls.listVerified(cursor?: string, limit?: number, status?: 'pending' | 'approved' | 'rejected' | 'escalated' | 'malicious'): { id: string; createdAt: string; domain: string; status: 'pending' | 'approved' | 'rejected' | 'escalated' | 'malicious'; url: string; approvalType?: 'manual' | 'auto_web_risk'; updatedAt?: string; }`\n\n**get** `/v1/urls`\n\nList URLs that have been verified for this project.\n\n### Parameters\n\n- `cursor?: string`\n\n- `limit?: number`\n\n- `status?: 'pending' | 'approved' | 'rejected' | 'escalated' | 'malicious'`\n  Filter by verification status.\n\n### Returns\n\n- `{ id: string; createdAt: string; domain: string; status: 'pending' | 'approved' | 'rejected' | 'escalated' | 'malicious'; url: string; approvalType?: 'manual' | 'auto_web_risk'; updatedAt?: string; }`\n\n  - `id: string`\n  - `createdAt: string`\n  - `domain: string`\n  - `status: 'pending' | 'approved' | 'rejected' | 'escalated' | 'malicious'`\n  - `url: string`\n  - `approvalType?: 'manual' | 'auto_web_risk'`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\n// Automatically fetches more pages as needed.\nfor await (const verifiedURL of client.urls.listVerified()) {\n  console.log(verifiedURL);\n}\n```",
    perLanguage: {
      typescript: {
