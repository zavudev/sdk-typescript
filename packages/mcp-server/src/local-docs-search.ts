...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: ['channel?: string;', 'cursor?: string;', 'limit?: number;', 'status?: string;', 'to?: string;'],
    response:
      "{ id: string; channel: string; createdAt: string; messageType: string; status: string; to: string; content?: { buttons?: object[]; contacts?: object[]; ctaDisplayText?: string; ctaHeaderMediaUrl?: string; ctaHeaderText?: string; ctaHeaderType?: 'text' | 'image' | 'video' | 'document'; ctaUrl?: string; emoji?: string; filename?: string; footerText?: string; latitude?: number; listButton?: string; locationAddress?: string; locationName?: string; longitude?: number; mediaId?: string; mediaUrl?: string; mimeType?: string; reactToMessageId?: string; replyToFrom?: string; replyToMessageId?: string; replyToMessageType?: string; replyToProviderMessageId?: string; replyToText?: string; sections?: object[]; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; }; cost?: number; costProvider?: number; costTotal?: number; errorCode?: string; errorMessage?: string; from?: string; metadata?: object; providerMessageId?: string; senderId?: string; text?: string; updatedAt?: string; }",
    markdown:
      "## list\n\n`client.messages.list(channel?: string, cursor?: string, limit?: number, status?: string, to?: string): { id: string; channel: channel; createdAt: string; messageType: message_type; status: message_status; to: string; content?: message_content; cost?: number; costProvider?: number; costTotal?: number; errorCode?: string; errorMessage?: string; from?: string; metadata?: object; providerMessageId?: string; senderId?: string; text?: string; updatedAt?: string; }`\n\n**get** `/v1/messages`\n\nList messages previously sent by this project.\n\n### Parameters\n\n- `channel?: string`\n  Delivery channel. Use 'auto' for intelligent routing.\n\n- `cursor?: string`\n\n- `limit?: number`\n\n- `status?: string`\n\n- `to?: string`\n\n### Returns\n\n- `{ id: string; channel: string; createdAt: string; messageType: string; status: string; to: string; content?: { buttons?: object[]; contacts?: object[]; ctaDisplayText?: string; ctaHeaderMediaUrl?: string; ctaHeaderText?: string; ctaHeaderType?: 'text' | 'image' | 'video' | 'document'; ctaUrl?: string; emoji?: string; filename?: string; footerText?: string; latitude?: number; listButton?: string; locationAddress?: string; locationName?: string; longitude?: number; mediaId?: string; mediaUrl?: string; mimeType?: string; reactToMessageId?: string; replyToFrom?: string; replyToMessageId?: string; replyToMessageType?: string; replyToProviderMessageId?: string; replyToText?: string; sections?: object[]; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; }; cost?: number; costProvider?: number; costTotal?: number; errorCode?: string; errorMessage?: string; from?: string; metadata?: object; providerMessageId?: string; senderId?: string; text?: string; updatedAt?: string; }`\n\n  - `id: string`\n  - `channel: string`\n  - `createdAt: string`\n  - `messageType: string`\n  - `status: string`\n  - `to: string`\n  - `content?: { buttons?: { id: string; title: string; }[]; contacts?: { name?: string; phones?: string[]; }[]; ctaDisplayText?: string; ctaHeaderMediaUrl?: string; ctaHeaderText?: string; ctaHeaderType?: 'text' | 'image' | 'video' | 'document'; ctaUrl?: string; emoji?: string; filename?: string; footerText?: string; latitude?: number; listButton?: string; locationAddress?: string; locationName?: string; longitude?: number; mediaId?: string; mediaUrl?: string; mimeType?: string; reactToMessageId?: string; replyToFrom?: string; replyToMessageId?: string; replyToMessageType?: string; replyToProviderMessageId?: string; replyToText?: string; sections?: { rows: { id: string; title: string; description?: string; }[]; title: string; }[]; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; }`\n  - `cost?: number`\n  - `costProvider?: number`\n  - `costTotal?: number`\n  - `errorCode?: string`\n  - `errorMessage?: string`\n  - `from?: string`\n  - `metadata?: object`\n  - `providerMessageId?: string`\n  - `senderId?: string`\n  - `text?: string`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\n// Automatically fetches more pages as needed.\nfor await (const message of client.messages.list()) {\n  console.log(message);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      "channels: { channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; identifier: string; countryCode?: string; isPrimary?: boolean; label?: string; }[];",
      'displayName?: string;',
      'metadata?: object;',
    ],
    response:
      "{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }",
    markdown:
      "## create\n\n`client.contacts.create(channels: { channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; identifier: string; countryCode?: string; isPrimary?: boolean; label?: string; }[], displayName?: string, metadata?: object): { id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: contact_channel[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n**post** `/v1/contacts`\n\nCreate a new contact with one or more communication channels.\n\n### Parameters\n\n- `channels: { channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; identifier: string; countryCode?: string; isPrimary?: boolean; label?: string; }[]`\n  Communication channels for the contact.\n\n- `displayName?: string`\n  Display name for the contact.\n\n- `metadata?: object`\n  Arbitrary metadata to associate with the contact.\n\n### Returns\n\n- `{ id: string; availableChannels: string[]; createdAt: string; metadata: object; verified: boolean; channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }[]; countryCode?: string; defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'; displayName?: string; phoneNumber?: string; primaryEmail?: string; primaryPhone?: string; profileName?: string; suggestedMergeWith?: string; updatedAt?: string; }`\n\n  - `id: string`\n  - `availableChannels: string[]`\n  - `createdAt: string`\n  - `metadata: object`\n  - `verified: boolean`\n  - `channels?: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: { avgDeliveryTimeMs?: number; failureCount?: number; lastSuccessAt?: string; successCount?: number; totalAttempts?: number; }; updatedAt?: string; }[]`\n  - `countryCode?: string`\n  - `defaultChannel?: 'sms' | 'whatsapp' | 'telegram' | 'email' | 'instagram' | 'messenger' | 'voice'`\n  - `displayName?: string`\n  - `phoneNumber?: string`\n  - `primaryEmail?: string`\n  - `primaryPhone?: string`\n  - `profileName?: string`\n  - `suggestedMergeWith?: string`\n  - `updatedAt?: string`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst contact = await client.contacts.create({ channels: [{ channel: 'sms', identifier: '+14155551234' }] });\n\nconsole.log(contact);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ channel: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }; }",
    markdown:
      "## add\n\n`client.contacts.channels.add(contactId: string, channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice', identifier: string, countryCode?: string, isPrimary?: boolean, label?: string): { channel: contact_channel; }`\n\n**post** `/v1/contacts/{contactId}/channels`\n\nAdd a new communication channel to an existing contact.\n\n### Parameters\n\n- `contactId: string`\n\n- `channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'`\n  Channel type.\n\n- `identifier: string`\n  Channel identifier (phone number in E.164 format or email address).\n\n- `countryCode?: string`\n  ISO country code for phone numbers.\n\n- `isPrimary?: boolean`\n  Whether this should be the primary channel for its type.\n\n- `label?: string`\n  Optional label for the channel.\n\n### Returns\n\n- `{ channel: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: object; updatedAt?: string; }; }`\n\n  - `channel: { id: string; channel: 'sms' | 'whatsapp' | 'email' | 'telegram' | 'messenger' | 'voice'; createdAt: string; identifier: string; isPrimary: boolean; verified: boolean; countryCode?: string; label?: string; lastInboundAt?: string; metadata?: object; metrics?: { avgDeliveryTimeMs?: number; failureCount?: number; lastSuccessAt?: string; successCount?: number; totalAttempts?: number; }; updatedAt?: string; }`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst response = await client.contacts.channels.add('contactId', { channel: 'email', identifier: 'john.work@company.com' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; channel: string; createdAt: string; messageType: 'text' | 'image' | 'video' | 'audio' | 'document' | 'template'; name: string; status: string; totalContacts: number; actualCost?: number; completedAt?: string; content?: { filename?: string; mediaId?: string; mediaUrl?: string; mimeType?: string; templateButtonVariables?: object; templateHeaderVariables?: object; templateId?: string; templateVariables?: object; }; deliveredCount?: number; emailSubject?: string; estimatedCost?: number; failedCount?: number; metadata?: object; pendingCount?: number; reservedAmount?: number; reviewAttempts?: number; reviewResult?: { categories?: string[]; flaggedContent?: string[]; reasoning?: string; reviewedAt?: string; score?: number; }; scheduledAt?: string; senderId?: string; sendingCount?: number; startedAt?: string; text?: string; updatedAt?: string; }",
    markdown:
