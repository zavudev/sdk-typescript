...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ id: string; name: string; phoneNumber: string; createdAt?: string; emailAddress?: string; emailCatchAllEnabled?: boolean; emailReceivingEnabled?: boolean; isDefault?: boolean; updatedAt?: string; webhook?: { active: boolean; events: webhook_event[]; url: string; secret?: string; }; whatsapp?: { displayPhoneNumber?: string; paymentStatus?: { canSendTemplates?: boolean; methodStatus?: string; setupStatus?: string; }; phoneNumberId?: string; }; }',
    markdown:
      "## retrieve\n\n`client.senders.retrieve(senderId: string): { id: string; name: string; phoneNumber: string; createdAt?: string; emailAddress?: string; emailCatchAllEnabled?: boolean; emailReceivingEnabled?: boolean; isDefault?: boolean; updatedAt?: string; webhook?: sender_webhook; whatsapp?: object; }`\n\n**get** `/v1/senders/{senderId}`\n\nGet sender\n\n### Parameters\n\n- `senderId: string`\n\n### Returns\n\n- `{ id: string; name: string; phoneNumber: string; createdAt?: string; emailAddress?: string; emailCatchAllEnabled?: boolean; emailReceivingEnabled?: boolean; isDefault?: boolean; updatedAt?: string; webhook?: { active: boolean; events: webhook_event[]; url: string; secret?: string; }; whatsapp?: { displayPhoneNumber?: string; paymentStatus?: { canSendTemplates?: boolean; methodStatus?: string; setupStatus?: string; }; phoneNumberId?: string; }; }`\n\n  - `id: string`\n  - `name: string`\n  - `phoneNumber: string`\n  - `createdAt?: string`\n  - `emailAddress?: string`\n  - `emailCatchAllEnabled?: boolean`\n  - `emailReceivingEnabled?: boolean`\n  - `isDefault?: boolean`\n  - `updatedAt?: string`\n  - `webhook?: { active: boolean; events: string[]; url: string; secret?: string; }`\n  - `whatsapp?: { displayPhoneNumber?: string; paymentStatus?: { canSendTemplates?: boolean; methodStatus?: string; setupStatus?: string; }; phoneNumberId?: string; }`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst sender = await client.senders.retrieve('senderId');\n\nconsole.log(sender);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ invitation: { id: string; token: string; createdAt: string; expiresAt: string; status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled'; updatedAt: string; url: string; clientEmail?: string; clientName?: string; clientPhone?: string; completedAt?: string; connectionType?: 'whatsapp_waba'; phoneNumberId?: string; senderId?: string; startedAt?: string; viewedAt?: string; }; }",
    markdown:
      "## create\n\n`client.invitations.create(allowedPhoneCountries?: string[], clientEmail?: string, clientName?: string, clientPhone?: string, connectionType?: 'whatsapp_waba', expiresInDays?: number, phoneNumberId?: string): { invitation: invitation; }`\n\n**post** `/v1/invitations`\n\nCreate a partner invitation link for a client to connect WhatsApp. The client opens the returned `url` and completes Meta's embedded signup, linking an official WhatsApp Business Account. The resulting sender is created in your project when the client completes the flow, and the invitation transitions to `completed`.\n\n### Parameters\n\n- `allowedPhoneCountries?: string[]`\n  ISO country codes for allowed phone numbers.\n\n- `clientEmail?: string`\n  Email of the client being invited.\n\n- `clientName?: string`\n  Name of the client being invited.\n\n- `clientPhone?: string`\n  Phone number of the client in E.164 format.\n\n- `connectionType?: 'whatsapp_waba'`\n  How the client connects WhatsApp. `whatsapp_waba` (default) runs Meta's embedded signup to link an official WhatsApp Business Account.\n\n- `expiresInDays?: number`\n  Number of days until the invitation expires.\n\n- `phoneNumberId?: string`\n  ID of a Zavu phone number to pre-assign for WhatsApp registration. If provided, the client will use this number instead of their own.\n\n### Returns\n\n- `{ invitation: { id: string; token: string; createdAt: string; expiresAt: string; status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled'; updatedAt: string; url: string; clientEmail?: string; clientName?: string; clientPhone?: string; completedAt?: string; connectionType?: 'whatsapp_waba'; phoneNumberId?: string; senderId?: string; startedAt?: string; viewedAt?: string; }; }`\n\n  - `invitation: { id: string; token: string; createdAt: string; expiresAt: string; status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled'; updatedAt: string; url: string; clientEmail?: string; clientName?: string; clientPhone?: string; completedAt?: string; connectionType?: 'whatsapp_waba'; phoneNumberId?: string; senderId?: string; startedAt?: string; viewedAt?: string; }`\n\n### Example\n\n```typescript\nimport Zavudev from '@zavudev/sdk';\n\nconst client = new Zavudev();\n\nconst invitation = await client.invitations.create();\n\nconsole.log(invitation);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; token: string; createdAt: string; expiresAt: string; status: 'pending' | 'in_progress' | 'completed' | 'expired' | 'cancelled'; updatedAt: string; url: string; clientEmail?: string; clientName?: string; clientPhone?: string; completedAt?: string; connectionType?: 'whatsapp_waba'; phoneNumberId?: string; senderId?: string; startedAt?: string; viewedAt?: string; }",
    markdown:
