...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      ...
      'name: string;',
      'addSecurityRecommendation?: boolean;',
      "buttons?: { text: string; type: 'quick_reply' | 'url' | 'phone' | 'otp'; example?: string; otpType?: 'COPY_CODE' | 'ONE_TAP'; packageName?: string; phoneNumber?: string; signatureHash?: string; url?: string; }[];",
      'codeExpirationMinutes?: number;',
      'footer?: string;',
      'headerContent?: string;',
