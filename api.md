...
- <code><a href="./src/resources/senders.ts">SenderListResponse</a></code>
...
- <code title="get /v1/contacts">client.contacts.<a href="./src/resources/contacts.ts">list</a>({ ...params }) -> ContactListResponse</code>
