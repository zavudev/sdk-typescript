...
describe('resource tools', () => {
  ...
  // Mock server tests are disabled
  test.skip('listTestRuns: only required params', async () => {
    const responsePromise = client.senders.agent.tools.listTestRuns('toolId', { senderId: 'senderId' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('listTestRuns: required and optional params', async () => {
    const response = await client.senders.agent.tools.listTestRuns('toolId', {
      senderId: 'senderId',
      limit: 100,
    });
  });
