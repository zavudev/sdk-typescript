...
describe('resource webhook', () => {
  ...
  test.skip('rotateSecret: only required params', async () => {
    const responsePromise = client.senders.agent.tools.webhook.rotateSecret('toolId', {
      senderId: 'senderId',
    });
  ...
  test.skip('rotateSecret: required and optional params', async () => {
    const response = await client.senders.agent.tools.webhook.rotateSecret('toolId', {
      senderId: 'senderId',
    });
  });
});
