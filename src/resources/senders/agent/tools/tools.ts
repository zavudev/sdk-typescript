...
import { Webhook, WebhookRotateSecretParams } from './webhook';
...
export class Tools extends APIResource {
  ...
  listTestRuns(
    ...
    options?: RequestOptions,
  ): APIPromise<ToolListTestRunsResponse> {
    const { senderId, ...query } = params;
    return this._client.get(path`/v1/senders/${senderId}/agent/tools/${toolID}/test-runs`, {
      query,
      ...options,
    });
  }
...
export interface ToolListTestRunsResponse {
  items: Array<ToolListTestRunsResponse.Item>;
}

export namespace ToolListTestRunsResponse {
  /**
...
export interface ToolListTestRunsParams {
  /**
   * Path param
   */
  senderId: string;
...
export declare namespace Tools {
  ...
  export { Webhook as Webhook, type WebhookRotateSecretParams as WebhookRotateSecretParams };
}
